  ...
  return (
    <main className="flex min-h-screen items-center justify-center p-4">
      <div className="w-full max-w-sm space-y-4 text-center">
        ...
        <a
          href="/api/teacher/auth/start"
          className="flex items-center justify-center gap-3 w-full rounded border border-gray-300 px-4 py-2 text-sm font-medium hover:bg-gray-50"
        >
